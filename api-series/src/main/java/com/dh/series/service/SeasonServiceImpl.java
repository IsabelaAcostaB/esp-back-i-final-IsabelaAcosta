...
@Service
public class SeasonServiceImpl implements SeriesService {
    ...
    public void addSeason(String serieId, Season season) throws Exception {
        ...
        Serie serie = serieRepository.findById(serieId).orElseThrow(() -> new Exception("Oops! Series id " + serieId + "was not found"));
